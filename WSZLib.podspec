...
TODO: Add long description of the pod here.
  ...
  spec.frameworks   = 'CoreGraphics','Accelerate','SystemConfiguration','AssetsLibrary','CoreTelephony','QuartzCore','CoreFoundation','CoreLocation','ImageIO','CoreMedia','CoreMotion','AVFoundation','WebKit','libresolv','libz','libc++.1','libc++abi','AudioToolbox','CFNetwork','MobileCoreServices','libz.1.2.8','AdSupport'
